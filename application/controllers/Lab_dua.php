...
class Lab_dua extends CI_Controller {

 public function __construct() {
			parent::__construct();
			$this->load->model("model_lab_dua");
			$this->data['sql'] = $this->model_lab_dua->getlab();
		}
	...
	public function index() {
		...
		$this->load->view('view_admin/lab_dua/view_lab_dua',$this->data);
  ...
  public function simpan() {
    ...
    $data         = array(
		...
		$this->model_lab_dua->simpan($data);
  ...
  $this->model_lab_dua->update($id,$data);
  ...
  public function ubah($id)	{
    $this->Model_security->getsecurity();
		$data['ed'] = 'update';
		$data['sql'] = $this->model_lab_dua->ubah($id);
    $this->load->view('view_admin/view_sidebar');
		$this->load->view('view_admin/view_header');
		$this->load->view('view_admin/lab_dua/form_lab_dua',$data);
		$this->load->view('view_footer');
