...
class Ruang_admin_laboran extends CI_Controller {

 public function __construct() {
			parent::__construct();
			$this->load->model("model_ruang_admin_laboran");
			$this->data['sql'] = $this->model_ruang_admin_laboran->getlab();
		}
    ...
    $back	= $this->agent->referrer();
		...
		$this->load->view('view_laboran/ruang_admin/view_lab',$this->data);
    ...
    // $this->Model_security->getsecurity();
		...
		$this->load->view('view_laboran/view_sidebar_laboran',$this->data);
		$this->load->view('view_laboran/view_header_laboran');
		$this->load->view('view_laboran/ruang_admin/form_lab',$data);
		$this->load->view('view_footer');
    $back	= $this->agent->referrer();
	}
  ...
  $this->model_ruang_admin_laboran->update($id,$data);
  ...
  public function ubah($id)	{
    // $this->Model_security->getsecurity();
		$data['ed'] = 'update';
		$data['sql'] = $this->model_ruang_admin_laboran->ubah($id);
