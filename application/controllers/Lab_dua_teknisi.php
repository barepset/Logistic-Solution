...
class Lab_dua_teknisi extends CI_Controller {

 public function __construct() {
			parent::__construct();
			$this->load->model("model_lab_dua_teknisi");
			$this->data['sql'] = $this->model_lab_dua_teknisi->getlab();
		}
	...
	public function index() {
		...
		$this->load->view('view_teknisi/lab_dua/view_lab_dua',$this->data);
    ...
    // $this->Model_security->getsecurity();
		...
		$this->load->view('view_teknisi/view_sidebar_teknisi');
		$this->load->view('view_teknisi/view_header_teknisi');
		$this->load->view('view_teknisi/lab_dua/form_lab_dua',$data);
		$this->load->view('view_footer');
	}
  ...
  $this->model_lab_dua_teknisi->update($id,$data);
  ...
  public function ubah($id)	{
    // $this->Model_security->getsecurity();
		$data['ed'] = 'update';
		$data['sql'] = $this->model_lab_dua_teknisi->ubah($id);
    $this->load->view('view_teknisi/view_sidebar_teknisi');
		$this->load->view('view_teknisi/view_header_teknisi');
		$this->load->view('view_teknisi/lab_dua/form_lab_dua',$data);
		$this->load->view('view_footer');
