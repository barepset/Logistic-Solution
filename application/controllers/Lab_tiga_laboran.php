...
class Lab_tiga_laboran extends CI_Controller {

 public function __construct() {
			parent::__construct();
			$this->load->model("model_lab_tiga_laboran");
			$this->data['sql'] = $this->model_lab_tiga_laboran->getlab();
		}
	...
	public function index() {
		...
		$this->load->view('view_laboran/lab_tiga/view_lab_tiga',$this->data);
    ...
    // $this->Model_security->getsecurity();
		...
		$this->load->view('view_laboran/view_sidebar_laboran');
		$this->load->view('view_laboran/view_header_laboran');
		$this->load->view('view_laboran/lab_tiga/form_lab_tiga',$data);
		$this->load->view('view_footer');
	}
  ...
  public function simpan() {
    ...
    $data         = array(
		...
		$this->model_lab_tiga->simpan($data);
  ...
  $this->model_lab_tiga_laboran->update($id,$data);
  ...
  public function ubah($id)	{
    // $this->Model_security->getsecurity();
		$data['ed'] = 'update';
		$data['sql'] = $this->model_lab_tiga_laboran->ubah($id);
    $this->load->view('view_laboran/view_sidebar_laboran');
		$this->load->view('view_laboran/view_header_laboran');
		$this->load->view('view_laboran/lab_tiga/form_lab_tiga',$data);
		$this->load->view('view_footer');
