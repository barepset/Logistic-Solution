...
class Lab_kom_dua extends CI_Controller {

 public function __construct() {
			parent::__construct();
			$this->load->model("model_lab_kom_dua");
			$this->data['sql'] = $this->model_lab_kom_dua->getlab();
		}
    ...
    $back	= $this->agent->referrer();
		...
		$this->load->view('view_admin/lab_kom_dua/view_lab',$this->data);
    ...
    $this->Model_security->getsecurity();
		...
		$this->load->view('view_admin/view_sidebar',$this->data);
		$this->load->view('view_admin/view_header');
		$this->load->view('view_admin/lab_kom_dua/form_lab',$data);
		$this->load->view('view_footer');
    $back	= $this->agent->referrer();
	}
  ...
  $this->model_lab_kom_dua->update($id,$data);
  ...
  public function hapus($id){
    $this->Model_security->getsecurity();
		$this->model_lab_kom_dua->hapus($id);
  ...
  public function ubah($id)	{
    $this->Model_security->getsecurity();
		$data['ed'] = 'update';
		$data['sql'] = $this->model_lab_kom_dua->ubah($id);
