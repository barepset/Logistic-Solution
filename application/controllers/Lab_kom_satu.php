...
class Lab_kom_satu extends CI_Controller {

 public function __construct() {
			parent::__construct();
			$this->load->model("model_lab_kom");
			$this->data['sql'] = $this->model_lab_kom->getlab();
		}
    ...
    $back	= $this->agent->referrer();
		...
		$this->load->view('view_admin/lab_kom_satu/view_lab',$this->data);
    ...
    $this->Model_security->getsecurity();
		...
		$this->load->view('view_admin/view_sidebar',$this->data);
		$this->load->view('view_admin/view_header');
		$this->load->view('view_admin/lab_kom_satu/form_lab',$data);
		$this->load->view('view_footer');
    $back	= $this->agent->referrer();
	}
  ...
  public function simpan() {
    ...
    $data         = array(
		...
		$this->model_lab_kom->simpan($data);
  ...
  $this->model_lab_kom->update($id,$data);
  ...
  public function ubah($id)	{
    $this->Model_security->getsecurity();
		$data['ed'] = 'update';
		$data['sql'] = $this->model_lab_kom->ubah($id);
