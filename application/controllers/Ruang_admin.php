...
class Ruang_admin extends CI_Controller {

 public function __construct() {
			parent::__construct();
			$this->load->model("model_ruang_admin");
			$this->data['sql'] = $this->model_ruang_admin->getlab();
		}
    ...
    $back	= $this->agent->referrer();
		...
		$this->load->view('view_admin/ruang_admin/view_lab',$this->data);
    ...
    $this->Model_security->getsecurity();
		...
		$this->load->view('view_admin/view_sidebar',$this->data);
		$this->load->view('view_admin/view_header');
		$this->load->view('view_admin/ruang_admin/form_lab',$data);
		$this->load->view('view_footer');
    $back	= $this->agent->referrer();
	}
  ...
  $this->model_ruang_admin->update($id,$data);
  ...
  public function hapus($id){
    $this->Model_security->getsecurity();
		$this->model_ruang_admin->hapus($id);
  ...
  public function ubah($id)	{
    $this->Model_security->getsecurity();
		$data['ed'] = 'update';
		$data['sql'] = $this->model_ruang_admin->ubah($id);
