...
class Lab_tiga extends CI_Controller {

 public function __construct() {
			parent::__construct();
			$this->load->model("model_lab_tiga");
			$this->data['sql'] = $this->model_lab_tiga->getlab();
		}
	...
	public function index() {
		...
		$this->load->view('view_admin/lab_tiga/view_lab_tiga',$this->data);
    ...
    $this->Model_security->getsecurity();
		...
		$this->load->view('view_admin/view_sidebar');
		$this->load->view('view_admin/view_header');
		$this->load->view('view_admin/lab_tiga/form_lab_tiga',$data);
		$this->load->view('view_footer');
	}
  ...
  $this->model_lab_tiga->update($id,$data);
  ...
  public function ubah($id)	{
    $this->Model_security->getsecurity();
		$data['ed'] = 'update';
		$data['sql'] = $this->model_lab_tiga->ubah($id);
    $this->load->view('view_admin/view_sidebar');
		$this->load->view('view_admin/view_header');
		$this->load->view('view_admin/lab_tiga/form_lab_tiga',$data);
		$this->load->view('view_footer');
