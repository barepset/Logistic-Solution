...
class Lab_komsatu_teknisi extends CI_Controller {
 ...
 public function __construct() {
    ...
    $back	= $this->agent->referrer();
		...
		$this->load->view('view_teknisi/lab_kom_satu/view_lab',$this->data);
    ...
    // $this->Model_security->getsecurity();
		...
		$this->load->view('view_teknisi/view_sidebar_teknisi',$this->data);
		$this->load->view('view_teknisi/view_header_teknisi');
		$this->load->view('view_teknisi/lab_kom_satu/form_lab',$data);
		$this->load->view('view_footer');
    $back	= $this->agent->referrer();
	}
