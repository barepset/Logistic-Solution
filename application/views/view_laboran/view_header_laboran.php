<!DOCTYPE html>
  <html>
    <head>
      ...
      <title>LAB Poltek | Dashboard</title>
...
<div class="wrapper">
  <header class="main-header">
    <a href="<?php echo base_url(); ?>index.php/dashboard" class="logo">
      ...
      <span class="logo-lg"><b>Laboran</b>&nbsp;LAB</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url(); ?>assets/adminlte/dist/img/user3-128x128.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">Laboran</span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo base_url(); ?>index.php/dashboard_laboran/logout" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
