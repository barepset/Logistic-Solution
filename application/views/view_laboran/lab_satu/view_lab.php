...
<div id="example1_filter" class="dataTables_filter">
  <div class="btn-group">
    <!-- <button type="button" class="btn btn-warning btn-flat disabled">Cetak</button>
    <button type="button" class="btn btn-warning btn-flat dropdown-toggle disabled" data-toggle="dropdown">
  ...
  <li><a href="#">PRINT</a></li>
    ...
    <!-- <a class='btn btn-flat btn-primary disabled' href="<?=base_url()?>index.php/lab/add">Tambah Barang</a> -->
  </div>
</div>
              </div>
                <div class="col-xs-18">
        ...
        ?>
                        ...
                        <tr role="row" class="odd">
                          ...
                          <td>
                            <a href="<?=base_url(); ?>index.php/lab_laboran/ubah/<?php echo $obj['kode_barang']; ?>"class='btn btn-xs btn-flat btn-info'>Ubah</a>
          					       <!-- <a href="javascript:if(confirm('Apakah Anda Yakin Menghapus Data ini  ?')){document.location='<?php echo base_url(); ?>index.php/lab/hapus/<?php echo $obj['kode_barang']; ?>';}" class='btn btn-flat btn-xs btn-danger disabled'>Hapus</a> -->
                          </td>
                        </tr>
                        </tbody>
