  ...
  <section class="content">
    <div class="row">
      <div class="col-xs-12">
            ...
            <form role="form" action="<?= base_url('index.php/pinjam_laboran')."/$ed"?>" method="POST" >
              <div class="box-body">
              ...
              <div class="box-footer">
                &nbsp;&nbsp;&nbsp;
                <!-- <button href="<?php echo base_url(); ?>index.php/pinjam_laboran" class="btn btn-flat btn-danger"  >BATAL</button> -->
