...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <p class="login-box-msg">Silahkan login sebagai Laboran</p>

    <form action="<?php echo base_url(); ?>index.php/login_laboran/dapatlogin" onsubmit="return cekform();" method="post">
