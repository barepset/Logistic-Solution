<div class="content-wrapper">
  <section class="content-header">
    <h1>
      Data Barang
      <small>LAB Kom I</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-table"></i> Data Barang</a></li>
      <li class="active">LAB Kom I</li>
    </ol>
</section>
...
<div class="col-md-12">
  <div class="box box-info">
    <div class="box-header">
      <h3 class="box-title">Data Barang LAB Kom I</h3>
      </div>
        <div class="box-body">
...
<div id="example1_filter" class="dataTables_filter">
  ...
  <li><a href="<?php echo base_url(); ?>index.php/c_excel_kom">EXCEL</a></li>
  <!-- <li><a href="#">PDF</a></li> -->
  <li><a href="<?php echo base_url(); ?>index.php/cetak_kom">PRINT</a></li>
 </ul>
</div>
    <a class='btn btn-flat btn-primary' href="<?=base_url()?>index.php/lab_kom_satu/add">Tambah Barang</a>
  </div>
</div>
              </div>
                <div class="col-xs-18">
        ...
        ?>
                        ...
                        <tr role="row" class="odd">
                          ...
                          <td>
                            <a href="<?=base_url(); ?>index.php/lab_kom_satu/ubah/<?php echo $obj['kode_barang']; ?>"class='btn btn-xs btn-flat btn-info'>Ubah</a>
          					        <a href="javascript:if(confirm('Apakah Anda Yakin Menghapus Data ini  ?')){document.location='<?php echo base_url(); ?>index.php/lab_kom_satu/hapus/<?php echo $obj['kode_barang']; ?>';}" class='btn btn-flat btn-xs btn-danger'>Hapus</a>
                          </td>
                        </tr>
                        </tbody>
