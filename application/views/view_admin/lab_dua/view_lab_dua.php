...
<div class="col-xs-12">
  <div class="box box-info">
    <div class="box-header">
      <h3 class="box-title">Data Barang LAB II (Dua)</h3>
      </div>
        <div class="box-body">
...
<div id="example1_filter" class="dataTables_filter">
  ...
  <li><a href="<?php echo base_url(); ?>index.php/c_excel_dua">EXCEL</a></li>
  <!-- <li><a href="#">PDF</a></li> -->
  <li><a href="<?php echo base_url(); ?>index.php/cetak_dua">PRINT</a></li>
 </ul>
</div>
    <a class='btn btn-flat btn-primary' href="<?=base_url()?>index.php/lab_dua/add">Tambah Barang</a>
  </div>
</div>
              </div>
        ...
        ?>
                        ...
                        <tr role="row" class="odd">
                          ...
                          <td>
                            <a href="<?=base_url(); ?>index.php/lab_dua/ubah/<?php echo $obj['kode_barang']; ?>"class='btn btn-xs btn-flat btn-info'>Ubah</a>
          					        <a href="javascript:if(confirm('Apakah Anda Yakin Menghapus Data ini  ?')){document.location='<?php echo base_url(); ?>index.php/lab_dua/hapus/<?php echo $obj['kode_barang']; ?>';}" class='btn btn-flat btn-xs btn-danger'>Hapus</a>
                          </td>
                        </tr>
                        </tbody>
