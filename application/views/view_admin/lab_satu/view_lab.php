...
<div id="example1_filter" class="dataTables_filter">
  ...
  <li><a href="<?php echo base_url(); ?>index.php/c_excel">EXCEL</a></li>
  <!-- <li><a href="#">PDF</a></li> -->
  <li><a href="<?php echo base_url(); ?>index.php/cetak">PRINT</a></li>
 </ul>
</div>
    <a class='btn btn-flat btn-primary' href="<?=base_url()?>index.php/lab/add">Tambah Barang</a>
  </div>
</div>
              </div>
                <div class="col-xs-18">
        ...
        ?>
                        ...
                        <tr role="row" class="odd">
                          ...
                          <!-- <td><?php echo $obj['max'] ?> </td>
                          <td><?php echo $kerusakan ?></td> -->
                          <td><?php echo $obj['tahun'] ?></td>
                          <td><?php echo $obj['asal_barang'] ?></td>
                          <td><?php echo $obj['keadaan'] ?></td>
                          <td>
                            <a href="<?=base_url(); ?>index.php/lab/ubah/<?php echo $obj['kode_barang']; ?>"class='btn btn-xs btn-flat btn-INFO'>Ubah</a>
          					        <a href="javascript:if(confirm('Apakah Anda Yakin Menghapus Data ini  ?')){document.location='<?php echo base_url(); ?>index.php/lab/hapus/<?php echo $obj['kode_barang']; ?>';}" class='btn btn-flat btn-xs btn-danger'>Hapus</a>
                          </td>
                        </tr>
                        </tbody>
