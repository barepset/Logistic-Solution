...
<div id="example1_filter" class="dataTables_filter">
  ...
  <li><a href="<?php echo base_url(); ?>index.php/cetak_pinjam">PRINT</a></li>
   ...
   <!-- <a class='btn btn-flat btn-primary' href="<?=base_url()?>index.php/stok/add">Tambah Barang</a> -->
  </div>
</div>
              </div>
                <div class="col-xs-18">
       ...
       <?php
        ...
        ?>
                        ...
                        <td>
                           <!--  <a href="<?=base_url(); ?>index.php/stok/ubah/<?php echo $obj['id_pinjam']; ?>"class='btn btn-xs btn-flat btn-info'>Ubah</a>
          					        <a href="javascript:if(confirm('Apakah Anda Yakin Menghapus Data ini  ?')){document.location='<?php echo base_url(); ?>index.php/stok/hapus/<?php echo $obj['id_pinjam']; ?>';}" class='btn btn-flat btn-xs btn-danger'>Hapus</a> -->
                          </td>
                        </tr>
                        </tbody>
