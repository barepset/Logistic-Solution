  ...
  <section class="content">
    <div class="row">
      <div class="col-xs-12">
            ...
            <form role="form" action="<?= base_url('index.php/lab_teknisi')."/$ed"?>" method="POST" >
              <div class="box-body">
                ...
                <div class="form-group col-md-3 ">
                  <label>Jumlah Barang</label>
                    ...
                    <input type="button" class="btn btn-success" value="+" onclick="javascript:this.form.jumlah.value++">
                    <input type="button" class="btn btn-warning" value="-" onclick="javascript:this.form.jumlah.value--" disabled="">
                </div>
                <div class="form-group col-md-4 ">
              ...
              <div class="box-footer">
                &nbsp;&nbsp;&nbsp;
                <!-- <button href="<?php echo base_url(); ?>index.php/lab_teknisi" class="btn btn-flat btn-danger"  >BATAL</button> -->
