...
<div id="example1_filter" class="dataTables_filter">
  ...
  <li><a href="#">PRINT</a></li>
   ...
   <!-- <a class='btn btn-flat btn-primary disabled' href="<?=base_url()?>index.php/lab_teknisi/add">Tambah Barang</a> -->
  </div>
</div>
              </div>
                <div class="col-xs-18">
        ...
        ?>
                        ...
                        <tr role="row" class="odd">
                          ...
                          <td>
                            <a href="<?=base_url(); ?>index.php/lab_teknisi/ubah/<?php echo $obj['kode_barang']; ?>"class='btn btn-flat btn-info btn-xs'>Ubah</a>
          					      <!--  <a href="javascript:if(confirm('Apakah Anda Yakin Menghapus Data ini  ?')){document.location='<?php echo base_url(); ?>index.php/lab_teknisi/hapus/<?php echo $obj['kode_barang']; ?>';}" class='btn btn-flat btn-danger btn-xs disabled'>Hapus</a> -->
                          </td>
                        </tr>
                        </tbody>
