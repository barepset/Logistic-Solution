...
<div id="example1_filter" class="dataTables_filter">
  ...
  <li><a href="#">PRINT</a></li>
   ...
   <!-- <a class='btn btn-flat btn-primary disabled' href="<?=base_url()?>index.php/lab_tiga_teknisi/add">Tambah Barang</a> -->
  </div>
</div>
              </div>
        ...
        ?>
                        ...
                        <tr role="row" class="odd">
                          ...
                          <td>
                            <a href="<?=base_url(); ?>index.php/lab_tiga_teknisi/ubah/<?php echo $obj['kode_barang']; ?>"class='btn btn-xs btn-flat btn-info'>Ubah</a>
