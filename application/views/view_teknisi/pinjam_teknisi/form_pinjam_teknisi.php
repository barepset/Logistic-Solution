  ...
  <section class="content">
    <div class="row">
      <div class="col-xs-12">
            ...
            <form role="form" action="<?= base_url('index.php/pinjam_teknisi')."/$ed"?>" method="POST" >
              <div class="box-body">
                <div class="form-group col-md-4  ">
                  <label>id_pinjam</label>
                  <input type="text" name="id_pinjam" value="<?php echo $id_pinjam; ?>" class="form-control" placeholder="">
                </div>
                <div class=" form-group col-md-4">
                  <label>Kode Barang</label>
                  <input type="text" name="kode_barang" value="<?php echo $kode_barang; ?>" class=" form-control" placeholder="">
                </div>

                <div class="form-group col-md-8 ">
                  <label>Nama Barang</label>
                  <input type="text" name="nama_barang" value="<?php echo $nama_barang; ?>" class="form-control" placeholder="">
                </div>
              ...
              <div class="box-footer">
                &nbsp;&nbsp;&nbsp;
                <!-- <button href="<?php echo base_url(); ?>index.php/pinjam_teknisi" class="btn btn-flat btn-danger"  >BATAL</button> -->
